...
class IterativeSolutionTest(NumpyAwareTestCase):
    ...
    def test_add_solution_with_defaults(self):
        ...
        self.assertNumpyArrayAlmostEqual(self._test_obj.solution(iteration=1), self._test_values)
        self.assertNumpyArrayAlmostEqual(self._test_obj.solution(iteration=1), self._test_obj.solution())
    ...
    def test_add_solution_with_specific_level(self):
        ...
        self.assertEqual(len(self._test_obj.values), 3)
        self.assertNumpyArrayAlmostEqual(self._test_obj.solution(iteration=1), self._test_values)
        self.assertIsNone(self._test_obj.values[1])
        self.assertNumpyArrayAlmostEqual(self._test_obj.solution(iteration=3), self._test_values)
        self.assertNumpyArrayAlmostEqual(self._test_obj.values[2], self._test_obj.solution(iteration=3))
